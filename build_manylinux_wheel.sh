...
MEDIAPIPE_PYTHON_BUILD_DIFF_URL="${MEDIAPIPE_PYTHON_BUILD_DIFF_URL:-https://github.com/chromium/chromium/blob/main/mediapipe/src/mediapipe_python_build.diff}"
