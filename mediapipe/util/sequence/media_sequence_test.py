...
class MediaSequenceTest(tf.test.TestCase):
    ...
    def test_point_round_trip(self):
        example = tf.train.SequenceExample()
        points = np.array([[0.1, 0.2], [0.5, 0.6]])
    ...
    def test_3d_point_round_trip(self):
        example = tf.train.SequenceExample()
        points = np.array([[0.1, 0.2, 0.3], [0.5, 0.6, 0.7]])
    ...
    def test_feature_timestamp_round_trip(self):
        ...
        self.assertAllClose(values_1, ms.get_feature_timestamp_at(0, example, "1"))
        self.assertAllClose(values_2, ms.get_feature_timestamp_at(0, example, "2"))
    ...
    def test_feature_dimensions_round_trip(self):
        ...
        self.assertSequenceEqual([47, 49], ms.get_feature_dimensions(example, "1"))
        self.assertSequenceEqual([49, 50], ms.get_feature_dimensions(example, "2"))
