...
msu.create_bytes_list_feature_list(
    "string_list_feature_list", "string_list_feature_list", module_dict=msu.__dict__
)
msu.create_float_list_feature_list(
    "float_list_feature_list", "float_list_feature_list", module_dict=msu.__dict__
)
msu.create_int_list_feature_list(
    "int64_list_feature_list", "int64_list_feature_list", module_dict=msu.__dict__
)
...
class MediaSequenceTest(tf.test.TestCase):
    def test_set_context_float(self):
        ...
        self.assertAlmostEqual(0.1, example.context.feature[key].float_list.value[0])

    def test_set_context_bytes(self):
        example = tf.train.SequenceExample()
        key = "test_string"
        msu.set_context_bytes(key, b"test", example)
        self.assertEqual(b"test", example.context.feature[key].bytes_list.value[0])

    def test_set_context_int(self):
        example = tf.train.SequenceExample()
        key = "test_int"
        msu.set_context_int(key, 47, example)
        self.assertEqual(47, example.context.feature[key].int64_list.value[0])
    ...
    def test_round_trip_bytes_list_feature(self):
        ...
        self.assertTrue(msu.has_feature_list(key, example))
        self.assertAllEqual(
            [b"test0", b"test1"], msu.get_bytes_list_at(key, 0, example)
        )
        self.assertAllEqual(
            [b"test1", b"test2"], msu.get_bytes_list_at(key, 1, example)
        )
        msu.clear_feature_list(key, example)
        self.assertEqual(0, msu.get_feature_list_size(key, example))
        self.assertFalse(msu.has_feature_list(key, example))
    ...
    def test_round_trip_float_context(self):
        ...
        self.assertAlmostEqual(0.47, example.context.feature[key].float_list.value[0])
    ...
    def test_round_trip_string_list_context(self):
        ...
        self.assertSequenceEqual(
            [b"test0", b"test1"], msu.get_string_list_context(example)
        )
        ...
        self.assertEqual("string_vector_feature", msu.get_string_list_context_key())

    def test_round_trip_float_list_context(self):
        example = tf.train.SequenceExample()
        msu.set_float_list_context([0.47, 0.49], example)
        self.assertSequenceAlmostEqual(
            [0.47, 0.49], msu.get_float_list_context(example)
        )
    ...
    def test_round_trip_string_list_feature_list(self):
        ...
        self.assertSequenceEqual(
            [b"test0", b"test1"], msu.get_string_list_feature_list_at(0, example)
        )
        self.assertSequenceEqual(
            [b"test1", b"test2"], msu.get_string_list_feature_list_at(1, example)
        )
        ...
        self.assertEqual(
            "string_list_feature_list", msu.get_string_list_feature_list_key()
        )
    ...
    def test_round_trip_float_list_feature_list(self):
        ...
        self.assertEqual(
            "float_list_feature_list", msu.get_float_list_feature_list_key()
        )
    ...
    def test_round_trip_int_list_feature_list(self):
        ...
        self.assertEqual(
            "int64_list_feature_list", msu.get_int64_list_feature_list_key()
        )
    ...
    def test_prefix_float_context(self):
        example = tf.train.SequenceExample()
        msu.set_float_context(47.0, example, prefix="magic")
        self.assertFalse(msu.has_float_context(example))
        self.assertTrue(msu.has_float_context(example, prefix="magic"))
        self.assertAlmostEqual(47.0, msu.get_float_context(example, prefix="magic"))
    ...
    def test_prefix_int64_list_context(self):
        ...
        self.assertEqual(
            ...
            msu.get_int64_list_context(example, prefix="magic"),
        )

    def test_prefix_float_list_context(self):
        example = tf.train.SequenceExample()
        msu.set_float_list_context((47.0,), example, prefix="magic")
        self.assertFalse(msu.has_float_list_context(example))
    ...
    def test_prefix_int64_feature_list(self):
        ...
        self.assertEqual(47, msu.get_int64_feature_list_at(0, example, prefix="magic"))

    def test_prefix_float_feature_list(self):
        example = tf.train.SequenceExample()
        msu.add_float_feature_list(47.0, example, prefix="magic")
        self.assertFalse(msu.has_float_feature_list(example))
        self.assertTrue(msu.has_float_feature_list(example, prefix="magic"))
        self.assertAlmostEqual(
            47.0, msu.get_float_feature_list_at(0, example, prefix="magic")
        )
    ...
    def test_prefix_int64_list_feature_list(self):
        ...
        self.assertEqual(
            ...
            msu.get_int64_list_feature_list_at(0, example, prefix="magic"),
        )

    def test_prefix_float_list_feature_list(self):
        example = tf.train.SequenceExample()
        msu.add_float_list_feature_list((47.0,), example, prefix="magic")
        self.assertFalse(msu.has_float_list_feature_list(example))
        ...
        self.assertAlmostEqual(
            ...
            msu.get_float_list_feature_list_at(0, example, prefix="magic"),
        )
