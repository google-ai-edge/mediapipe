...
from mediapipe.python._framework_bindings import (
    _packet_creator,
    image,
    image_frame,
    packet,
...
def create_image(
    ...
    *,
    ...
    if isinstance(data, image.Image):
        ...
        # pylint:disable=protected-access
        return _packet_creator._create_image_from_pixel_data(image_format, data, copy)
        # pylint:enable=protected-access
...
def create_proto(proto_message: message.Message) -> packet.Packet:
    ...
    """
    # pylint:disable=protected-access
    return _packet_creator._create_proto(
        proto_message.DESCRIPTOR.full_name, proto_message.SerializeToString()
    )
    # pylint:enable=protected-access
