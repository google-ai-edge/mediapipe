...
public class AndroidGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<AndroidGLSurfaceView> glSurfaceViewWeakRef) {
        ...
        private WeakReference<AndroidGLSurfaceView> mGLSurfaceViewWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
        ...
        GLThread(WeakReference<AndroidGLSurfaceView> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
...
//                                Trace.traceEnd(Trace.TRACE_TAG_VIEW);
    ...
    private final WeakReference<AndroidGLSurfaceView> mThisWeakRef =
            new WeakReference<AndroidGLSurfaceView>(this);
