...
# Build MTK dispatch library
bazel build //third_party/odml/litert/litert/vendors/mediatek/dispatch:dispatch_api_so --config=android_arm64 --//third_party/android/ndk:min_sdk_version=26
adb push bazel-bin/third_party/odml/litert/litert/vendors/mediatek/dispatch/libLiteRtDispatch_Mediatek.so /data/local/tmp/
...
# Run test
adb shell "cd /data/local/tmp; LD_LIBRARY_PATH=. ./inference_calculator_litert_test --model_filename=precompiled_mediatek_model.tflite"
