...
#ifndef MEDIAPIPE_CALCULATORS_TENSOR_INFERENCE_RUNNER_QNN_H_
#define MEDIAPIPE_CALCULATORS_TENSOR_INFERENCE_RUNNER_QNN_H_
...
// Inference runner implementation that uses the Qualcomm QNN Delegate.
class InferenceRunnerQnn : public InferenceRunner {
 public:
  ~InferenceRunnerQnn() override = default;
 ...
 private:
  ...
  mediapipe::InferenceCalculatorOptions options_;
...
#endif  // MEDIAPIPE_CALCULATORS_TENSOR_INFERENCE_RUNNER_QNN_H_
