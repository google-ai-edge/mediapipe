...
/** Generates [ParameterSpec] for [ImageSegmenterSettingsInternal]. */
object ImageSegmenterSpec {
  private val imageSegmenterResultCn =
  ...
  fun getParams(): List<ParameterSpec> =
    listOf(
      ParameterSpec.builder("outputConfidenceMasks", Boolean::class)
        .defaultValue(Constants.DEFAULT_OUTPUT_CONFIDENCE_MASKS)
        .build(),
      ParameterSpec.builder("outputCategoryMask", Boolean::class)
        .defaultValue(Constants.DEFAULT_OUTPUT_CATEGORY_MASK)
        .build(),
      ParameterSpec.builder(
          "displayNamesLocale",
          Constants.KOTLIN_STRING_CLASS.copy(nullable = true),
        )
