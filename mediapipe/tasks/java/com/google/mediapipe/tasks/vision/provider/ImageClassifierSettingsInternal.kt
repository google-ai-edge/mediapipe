...
/**
 * Internal settings for MediaPipe ImageClassifier task.
 *
...
constructor(
   ...
   * @return An [ImageClassifier.ImageClassifierOptions] instance.
   */
  fun toOptions(baseOptions: BaseOptions): ImageClassifier.ImageClassifierOptions {
    val optionsBuilder =
