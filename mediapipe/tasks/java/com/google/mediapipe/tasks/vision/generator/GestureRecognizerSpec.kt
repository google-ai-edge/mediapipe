...
/** Generates [ParameterSpec] for [GestureRecognizerSettingsInternal]. */
object GestureRecognizerSpec {
  private val gestureRecognizerResultCn =
    ClassName("com.google.mediapipe.tasks.vision.gesturerecognizer", "GestureRecognizerResult")
  private val classifierSettingsCn =
  ...
  fun getParams(): List<ParameterSpec> =
    listOf(
      ...
      ParameterSpec.builder("numHands", Int::class)
        .defaultValue(Constants.DEFAULT_NUM_HANDS)
        .build(),
      ParameterSpec.builder(
          "cannedGesturesClassifierSettings",
          classifierSettingsCn.copy(nullable = true),
        )
        .defaultValue("null")
        .build(),
      ParameterSpec.builder(
          "customGesturesClassifierSettings",
          classifierSettingsCn.copy(nullable = true),
        )
        .defaultValue("null")
        .build(),
