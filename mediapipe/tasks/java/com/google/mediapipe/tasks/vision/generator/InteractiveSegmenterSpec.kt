...
/** Generates [ParameterSpec] for [InteractiveSegmenterSettingsInternal]. */
object InteractiveSegmenterSpec {
  private val imageSegmenterResultCn =
    ClassName("com.google.mediapipe.tasks.vision.imagesegmenter", "ImageSegmenterResult")

  /** Gets the [ParameterSpec] list for [InteractiveSegmenterSettingsInternal]. */
  fun getParams(): List<ParameterSpec> =
    listOf(
      ...
      ParameterSpec.builder("outputCategoryMask", Boolean::class)
        .defaultValue(CodeBlock.of("%L", true))
        .build(),
