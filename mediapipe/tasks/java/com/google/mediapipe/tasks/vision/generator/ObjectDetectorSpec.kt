...
/** Generates [ParameterSpec] for [ObjectDetectorSettingsInternal]. */
object ObjectDetectorSpec {
  private val objectDetectorResultCn =
    ClassName("com.google.mediapipe.tasks.vision.objectdetector", "ObjectDetectorResult")

  /** Gets the [ParameterSpec] list for [ObjectDetectorSettingsInternal]. */
