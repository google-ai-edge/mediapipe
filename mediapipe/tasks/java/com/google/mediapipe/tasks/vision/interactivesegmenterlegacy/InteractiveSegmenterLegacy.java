...
package com.google.mediapipe.tasks.vision.interactivesegmenterlegacy;
...
import com.google.mediapipe.tasks.vision.interactivesegmenterlegacy.proto.RegionOfInterestProto;
 ...
 * image and returns the outputs, but involves deep copy of the returns, InteractiveSegmenterLegacy
 * also supports the callback API, {@link segmentWithResultListener}, which allows you to access the
 * outputs through zero copy. Set {@link ResultListener} in {@link
 * InteractiveSegmenterLegacyOptions} properly to use the callback API.
 *
 ...
 * </ul>
 */
public final class InteractiveSegmenterLegacy extends BaseVisionTaskApi {
  private static final String TAG = InteractiveSegmenterLegacy.class.getSimpleName();
  ...
  /**
   * Creates an {@link InteractiveSegmenterLegacy} instance from an {@link
   * InteractiveSegmenterLegacyOptions}.
   *
   * @param context an Android {@link Context}.
   * @param segmenterOptions an {@link InteractiveSegmenterLegacyOptions} instance.
   * @throws MediaPipeException if there is an error during {@link InteractiveSegmenterLegacy}
   *     creation.
   */
  public static InteractiveSegmenterLegacy createFromOptions(
      Context context, InteractiveSegmenterLegacyOptions segmenterOptions) {
    ...
    TaskRunner runner =
        TaskRunner.create(
            context,
            TaskInfo.<InteractiveSegmenterLegacyOptions>builder()
                .setTaskName(InteractiveSegmenterLegacy.class.getSimpleName())
                ...
                .build(),
            handler);
    return new InteractiveSegmenterLegacy(runner, segmenterOptions.resultListener().isPresent());
  }

  /**
   * Constructor to initialize an {@link InteractiveSegmenterLegacy} from a {@link TaskRunner}.
   *
   * @param taskRunner a {@link TaskRunner}.
   */
  private InteractiveSegmenterLegacy(TaskRunner taskRunner, boolean hasResultListener) {
   ...
   *
   * <p>{@link InteractiveSegmenterLegacy} supports the following color space types:
   *
   * <ul>
   ...
   * @throws MediaPipeException if there is an internal error. Or if {@link
   *     InteractiveSegmenterLegacy} is created with a {@link ResultListener}.
   */
  ...
  public ImageSegmenterResult segment(
    ...
    if (hasResultListener) {
      throw new MediaPipeException(
          ...
          "ResultListener is provided in the InteractiveSegmenterLegacyOptions, but this method"
              + " will return an ImageSegmentationResult.");
    }
   ...
   * via {@link ResultListener} in {@link InteractiveSegmenterLegacyOptions}.
   *
   ...
   *     region-of-interest.
   * @throws MediaPipeException if there is an internal error. Or if {@link
   *     InteractiveSegmenterLegacy} is not created with {@link ResultListener} set in {@link
   *     InteractiveSegmenterLegacyOptions}.
   */
   ...
   * provides zero-copied results via {@link ResultListener} in {@link
   * InteractiveSegmenterLegacyOptions}.
   *
   * <p>TODO update java doc for input image format.
   *
  ...
  public void segmentWithResultListener(
    ...
    if (!hasResultListener) {
      throw new MediaPipeException(
          MediaPipeException.StatusCode.FAILED_PRECONDITION.ordinal(),
          "ResultListener is not set in the InteractiveSegmenterLegacyOptions, but this method"
              + " expects a ResultListener to process ImageSegmentationResult.");
    }
    validateImageProcessingOptions(imageProcessingOptions);
  ...
  /** Options for setting up an {@link InteractiveSegmenterLegacy}. */
  @AutoValue
  public abstract static class InteractiveSegmenterLegacyOptions extends TaskOptions {

    /** Builder for {@link InteractiveSegmenterLegacyOptions}. */
    @AutoValue.Builder
    public abstract static class Builder {
      ...
      abstract InteractiveSegmenterLegacyOptions autoBuild();

      /** Builds the {@link InteractiveSegmenterLegacyOptions} instance. */
      public final InteractiveSegmenterLegacyOptions build() {
        return autoBuild();
      }
    }
    ...
    public static Builder builder() {
      return new AutoValue_InteractiveSegmenterLegacy_InteractiveSegmenterLegacyOptions.Builder()
          .setOutputConfidenceMasks(true)
          .setOutputCategoryMask(false);
    }

    /**
     * Converts an {@link InteractiveSegmenterLegacyOptions} to a {@link CalculatorOptions} protobuf
     * message.
     */
    @Override
  ...
  private static void validateImageProcessingOptions(
    ...
    if (imageProcessingOptions.regionOfInterest().isPresent()) {
      throw new IllegalArgumentException(
          "InteractiveSegmenterLegacy doesn't support region-of-interest.");
    }
  }
