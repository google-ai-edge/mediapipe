...
/**
 * Internal settings for MediaPipe HandLandmarker task.
 *
...
constructor(
   ...
   * @return A [HandLandmarker.HandLandmarkerOptions] instance.
   */
  fun toOptions(baseOptions: BaseOptions): HandLandmarker.HandLandmarkerOptions {
    val optionsBuilder =
