...
/**
 * Internal settings for MediaPipe ImageEmbedder task.
 *
 * @property l2Normalize Whether to L2-normalize the embedding.
 * @property quantize Whether to quantize the embedding.
...
constructor(
   ...
   * @return An [ImageEmbedder.ImageEmbedderOptions] instance.
   */
  fun toOptions(baseOptions: BaseOptions): ImageEmbedder.ImageEmbedderOptions {
    val optionsBuilder =
