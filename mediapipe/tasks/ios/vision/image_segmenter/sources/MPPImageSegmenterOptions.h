 ...
 *
 * @param imageSegmenter The image segmenter which performed the segmentation.
 * This is useful to test equality when there are multiple instances of `MPPImageSegmenter`.
