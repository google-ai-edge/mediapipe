...
@implementation MPPInteractiveSegmenterResult (Helpers)

+ (MPPInteractiveSegmenterResult *)
    interactiveSegmenterResultWithConfidenceMasksPacket:(const Packet &)confidenceMasksPacket
  ...
  return [[MPPInteractiveSegmenterResult alloc] initWithConfidenceMasks:confidenceMasks
