...
/** Hand landmarks in normalized image coordinates of detected left hands. */
@property(nonatomic, readonly) NSArray<NSArray<MPPNormalizedLandmark *> *> *leftHandLandmarks;

/** Hand landmarks in world coordinates of detected left hands. */
@property(nonatomic, readonly) NSArray<NSArray<MPPLandmark *> *> *leftHandWorldLandmarks;

/** Hand landmarks in normalized image coordinates of detected right hands. */
...
/**
 * Initializes a new `HolisticLandmarkerResult` with the given array of face landmarks, face blendshapes, pose landmarks, pose world landmarks, pose segmentation masks, left hand landmarks, left hand world landmarks, right hand landmarks, right hand world landmarks and timestamp (in milliseconds).
 *
 * @param faceLandmarks An array of `NormalizedLandmark` objects.
 * @param faceBlendshapes An array of `Classifications` objects.
 * @param poseLandmarks An array of `Landmark` objects.
 * @param poseWorldLandmarks An array of `Landmark` objects.
 * @param poseSegmentationMasks An array of `Mask` objects.
 * @param leftHandLandmarks An array of `Landmark` objects.
 * @param leftHandWorldLandmarks An array of `Landmark` objects.
 * @param rightHandLandmarks An array of `Landmark` objects.
 ...
 *
 * @return An instance of `HolisticLandmarkerResult` initialized with the given array of face landmarks, face blendshapes, pose landmarks, pose world landmarks, pose segmentation masks, left hand landmarks, left hand world landmarks, right hand landmarks, right hand world landmarks and timestamp (in milliseconds).
 */
