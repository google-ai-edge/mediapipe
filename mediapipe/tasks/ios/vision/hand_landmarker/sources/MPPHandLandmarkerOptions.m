...
@implementation MPPHandLandmarkerOptions
...
- (id)copyWithZone:(NSZone *)zone {
  MPPHandLandmarkerOptions *handLandmarkerOptions = [super copyWithZone:zone];

  handLandmarkerOptions.runningMode = self.runningMode;
  handLandmarkerOptions.handLandmarkerLiveStreamDelegate = self.handLandmarkerLiveStreamDelegate;
  handLandmarkerOptions.numHands = self.numHands;
