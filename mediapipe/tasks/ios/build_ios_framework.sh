...
# This function builds the iOS task .xcframework.
function build_ios_api_framework {
  ...
  local IOS_FRAMEWORK_PATH="$(get_output_file_path "${FRAMEWORK_CQUERY_COMMAND}")"
...
cd "${MPP_ROOT_DIR}"
IOS_API_FRAMEWORK_PATH="$(build_ios_api_framework)" 
create_framework_archive "${IOS_API_FRAMEWORK_PATH}"
