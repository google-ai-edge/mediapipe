...
/** An instance can contain erither a single normalized point pointing to the object that the user
 * wants to segment or array of normalized key points that make up scribbles over the object that
