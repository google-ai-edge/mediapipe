...
#ifndef MEDIAPIPE_TASKS_CC_COMPONENTS_TOKENIZERS_BERT_TOKENIZER_H_
#define MEDIAPIPE_TASKS_CC_COMPONENTS_TOKENIZERS_BERT_TOKENIZER_H_
...
class BertTokenizer : public mediapipe::tasks::tokenizer::Tokenizer {
 public:
 ...
 private:
  mediapipe::tasks::tokenizer::FlatHashMapBackedWordpiece vocab_;
...
#endif  // MEDIAPIPE_TASKS_CC_COMPONENTS_TOKENIZERS_BERT_TOKENIZER_H_
