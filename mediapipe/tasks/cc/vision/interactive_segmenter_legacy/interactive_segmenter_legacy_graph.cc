...
#include "mediapipe/tasks/cc/vision/interactive_segmenter_legacy/interactive_segmenter_legacy_graph.h"
...
using ::mediapipe::tasks::vision::interactive_segmenter_legacy::proto::
    RegionOfInterest;
}  // namespace
...
MEDIAPIPE_REGISTER_NODE(
    ::mediapipe::tasks::vision::interactive_segmenter_legacy::internal::RegionOfInterestToRenderDataCalculator);
// clang-format on
// NOLINTEND
...
Source<> RoiToAlpha(Source<Image> image, Source<RegionOfInterest> roi,
  ...
  auto& add_thickness = graph.AddNode(
      "mediapipe::tasks::vision::interactive_segmenter_legacy::internal::"
...
InteractiveSegmenterLegacyGraph::GetConfig(mediapipe::SubgraphContext* sc) {
  Graph graph;
...
REGISTER_MEDIAPIPE_GRAPH(
  ::mediapipe::tasks::vision::interactive_segmenter_legacy::InteractiveSegmenterLegacyGraph);  // NOLINT(whitespace/line_length)
// clang-format on
