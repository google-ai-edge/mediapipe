...
// Converts the user-facing InteractiveSegmenterLegacyOptions struct to the
// internal ImageSegmenterOptions proto.
std::unique_ptr<ImageSegmenterGraphOptionsProto>
ConvertImageSegmenterOptionsToProto(
...
absl::StatusOr<std::unique_ptr<InteractiveSegmenterLegacy>>
InteractiveSegmenterLegacy::Create(
  ...
  ABSL_ASSIGN_OR_RETURN(
      std::unique_ptr<InteractiveSegmenterLegacy> segmenter,
      (core::VisionTaskApiFactory::Create<InteractiveSegmenterLegacy,
...
absl::StatusOr<ImageSegmenterResult> InteractiveSegmenterLegacy::Segment(
  ...
  ABSL_ASSIGN_OR_RETURN(NormalizedRect norm_rect,
                        ConvertToNormalizedRect(image_processing_options, image,
                                                /*roi_allowed=*/false));
  ABSL_ASSIGN_OR_RETURN(proto::RegionOfInterest roi_data,
