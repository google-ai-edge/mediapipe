...
#ifndef MEDIAPIPE_TASKS_CC_VISION_INTERACTIVE_SEGMENTER_LEGACY_INTERACTIVE_SEGMENTER_LEGACY_H_
#define MEDIAPIPE_TASKS_CC_VISION_INTERACTIVE_SEGMENTER_LEGACY_INTERACTIVE_SEGMENTER_LEGACY_H_
...
namespace tasks {
namespace vision {
namespace interactive_segmenter_legacy {

// The options for configuring a mediapipe interactive segmenter task.
struct InteractiveSegmenterLegacyOptions {
...
//    must be set to true.
class InteractiveSegmenterLegacy : tasks::vision::core::BaseVisionTaskApi {
 public:
  using BaseVisionTaskApi::BaseVisionTaskApi;

  // Creates an InteractiveSegmenterLegacy from the provided options. A
  // non-default OpResolver can be specified in the BaseOptions of
  // InteractiveSegmenterLegacyOptions, to support custom Ops of the
  // segmentation model.
  static absl::StatusOr<std::unique_ptr<InteractiveSegmenterLegacy>> Create(
      std::unique_ptr<InteractiveSegmenterLegacyOptions> options);
  ...
  // Shuts down the InteractiveSegmenterLegacy when all works are done.
...
#endif  // MEDIAPIPE_TASKS_CC_VISION_INTERACTIVE_SEGMENTER_LEGACY_INTERACTIVE_SEGMENTER_LEGACY_H_
