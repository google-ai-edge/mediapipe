...
_CTYPES_SIGNATURES = (
    mediapipe_c_utils.CStatusFunction(
        ...
        (
            ctypes.POINTER(MpInteractiveSegmenterLegacyOptionsC),
...
class InteractiveSegmenterLegacyOptions:
  ...
  def to_ctypes(self) -> MpInteractiveSegmenterLegacyOptionsC:
    ...
    return MpInteractiveSegmenterLegacyOptionsC(
...
class InteractiveSegmenterLegacy:
  ...
  def create_from_model_path(
    ...
    options = InteractiveSegmenterLegacyOptions(base_options=base_options)
    return cls.create_from_options(options)

  @classmethod
  def create_from_options(
      cls, options: InteractiveSegmenterLegacyOptions
  ) -> 'InteractiveSegmenterLegacy':
