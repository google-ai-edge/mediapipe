...
_FaceDetectorGraphOptionsProto = face_detector_graph_options_pb2.FaceDetectorGraphOptions
...
class FaceDetectorOptions:
  ...
  Attributes:
    ...
    running_mode: The running mode of the task. Default to the image mode.
      ...
      3) The live stream mode for detecting faces on a live stream of input
         data, such as from camera.
    min_detection_confidence: The minimum confidence score for the face
      detection to be considered successful.
    min_suppression_threshold: The minimum non-maximum-suppression threshold
      for face detection to be considered overlapped.
    num_faces: Maximum number of faces to detect in the image.
...
class FaceDetector(base_vision_task_api.BaseVisionTaskApi):
  ...
  def create_from_options(cls,
                          options: FaceDetectorOptions) -> 'FaceDetector':
    ...
    def packets_callback(output_packets: Mapping[str, packet_module.Packet]):
      ...
      options.result_callback(detection_result, image,
