...
_KEYPOINT_1 = keypoint_c_lib.MpNormalizedKeypointC(
...
_KEYPOINT_2 = keypoint_c_lib.MpNormalizedKeypointC(
...
_RECT_1 = rect_c_lib.MpRectC(left=10, top=20, right=50, bottom=70)
_RECT_1_DICT = {
    'origin_x': 10,
    'origin_y': 20,
    'width': 40,
...
_RECT_2 = rect_c_lib.MpRectC(left=15, top=25, right=55, bottom=75)
_RECT_2_DICT = {
    'origin_x': 15,
    'origin_y': 25,
    'width': 40,
...
class DetectionsTest(absltest.TestCase):
  ...
  def test_create_detection_from_ctypes(self):
    ...
    c_keypoints = (keypoint_c_lib.MpNormalizedKeypointC * 2)(
  ...
  def test_create_detection_result_from_ctypes(self):
    ...
    c_detection_1 = detections_c_lib.MpDetectionC(
    ...
    c_categories_2 = (category_c_lib.MpCategoryC * 1)(_CATEGORY_WITHOUT_NAMES)
    c_keypoints_2 = (keypoint_c_lib.MpNormalizedKeypointC * 1)(_KEYPOINT_2)
    c_detection_2 = detections_c_lib.MpDetectionC(
    ...
    c_detections = (detections_c_lib.MpDetectionC * 2)(
        c_detection_1, c_detection_2
    )
    c_detection_result = detections_c_lib.MpDetectionResultC(
