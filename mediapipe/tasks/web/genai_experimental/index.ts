...
import {RagPipeline as RagPipelineImpl} from '../../../tasks/web/genai_experimental/rag_pipeline/rag_pipeline';

// Declare the variables locally so that Rollup in OSS includes them explicitly
// as exports.
const FilesetResolver = FilesetResolverImpl;
const RagPipeline = RagPipelineImpl;

export {FilesetResolver, RagPipeline};
